...
if __name__ == "__main__":
    ...
    for test_i in [2,7,11,14,16]: 
        ...
        # hex_params['youngs_modulus'] = 229939.0 #284503.8  
        # hex_params['poissons_ratio'] = 0.499 #0.4976 
        ...
        cantilever_sim = ThinnerCantileverEnv3d(42, 'beam', hex_params)
        q_init = torch.from_numpy(cantilever._q0)
        # print(cantilever._q0)
