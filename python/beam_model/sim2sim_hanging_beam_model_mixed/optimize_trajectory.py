...
def optimize_trajectoryfull( hex_params, num_frames, num_epochs, dt, sample=0, suffix = "sim2sim"):
    ...
    Path(f"cantilever_data_sim2sim").mkdir(parents=True,exist_ok=True)
    np.save(f"cantilever_data_sim2sim/optimized_data_{sample}.npy", optimized_data_save)
...
if __name__ == '__main__':
    ...
    for idx in idxs:
        ...
        num_frames = 100
        num_epochs = 300
        optimize_trajectoryfull(hex_params, num_frames, num_epochs, 1e-2, sample=idx)
