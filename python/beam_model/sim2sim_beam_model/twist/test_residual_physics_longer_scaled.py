...
if __name__ == "__main__":
    ...
    cantilever = LongerCantileverEnv3d(42, f"{save_folder}/longer_scaled/", hex_params)
    ...
    generate_video_directory(f"{save_folder}/longer_scaled/visualizations/residual", list(range(12,20)), flag="")
    generate_video_directory(f"{save_folder}/longer_scaled/visualizations/base", list(range(12,20)), flag="")
