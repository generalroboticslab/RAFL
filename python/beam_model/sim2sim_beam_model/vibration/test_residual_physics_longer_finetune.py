...
def test_trajectory(
    ...
    vis_1d_folder = f"longer_finetune_sim2sim/{save_folder.replace('training/', '').replace('/', '_')}_{model_input}"
...
if __name__ == "__main__":
    ...
    save_folder = f"training/test_refactor_element_new/longer_finetune"
    sim_errors = []
    res_errors = []
