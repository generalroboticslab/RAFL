...
class ThickerCantileverEnv3d (EnvBase):
    ...
    def __init__(self, seed, folder, options):
        ...
        dx = 0.01 / refinement
        cell_nums = (round(0.10 / dx), round(0.04 / dx), round(0.04 / dx))
        assert cell_nums[0] * dx == 0.10 and cell_nums[1] * dx == 0.04, "Refinement does not properly divide the cantilever dimensions!" 
