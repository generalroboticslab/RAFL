...
if __name__ == "__main__":
    ...
    for test_i in [2,7,11,14,16]: 
        ...
        cantilever_sim = ShorterCantileverEnv3d(42, 'beam_shorter_scaled', hex_params)
        ...
        if 'longer' not in save_folder and 'shorter' not in save_folder and 'thicker' not in save_folder and 'thinner' not in save_folder:
            ...
            cantilever_sim_2 = ShorterCantileverEnv3d(42, 'beam_shorter_scaled', hex_params)
        else:
    ...
    np.save(f"{save_folder}/shorter_scaled/origin_errors_residual_network.npy", origin_errors)