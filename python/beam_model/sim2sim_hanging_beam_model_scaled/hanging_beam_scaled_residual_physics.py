...
class HangingCantileverScaledResidualPhysics(ResidualPhysicsBase):
    def __init__(self, config, folder, options, target_dx=0.01):
        super().__init__(config)
        self.loss_fn = nn.MSELoss(reduction="mean")
        self.diffpd_model = HangingCantileverScaledEnv3d(config['seed'], folder, options, target_dx=target_dx)
