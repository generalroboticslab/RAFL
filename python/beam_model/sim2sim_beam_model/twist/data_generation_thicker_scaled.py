...
def data_generate(sample_num, frame_num, hex_params, vis=True):
    seed = 42
    folder = "thicker_scaled_data_real"
    refinement = 1
    ...
    for idx, twist_angle in enumerate(twist_angle_range):
        ...
        data_folder = 'thicker_scaled_data_real'
...
if __name__ == "__main__":
    ...
    generate_video_directory(f"thicker_scaled_data_real/visualizations", list(range(sample_num)), flag="")