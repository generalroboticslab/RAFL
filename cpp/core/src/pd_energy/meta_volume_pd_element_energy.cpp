...
template<int dim>
const Eigen::Matrix<real, dim, dim> MetaVolumePdElementEnergy<dim>::ProjectToManifold(
...
template<int dim>
const Eigen::Matrix<real, dim, dim> MetaVolumePdElementEnergy<dim>::ProjectToManifoldDifferential(
...
template class MetaVolumePdElementEnergy<2>;
template class MetaVolumePdElementEnergy<3>;