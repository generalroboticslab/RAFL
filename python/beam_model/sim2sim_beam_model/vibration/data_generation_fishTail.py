...
if __name__ == '__main__':
    ...
    prepare = 200
    save_folder = 'fishTail_data_real' if args.parse_args().save_folder is None else args.parse_args().save_folder
    cantilever = FishTailEnv3d(42, save_folder, hex_params)
