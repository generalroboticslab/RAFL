...
if __name__ == '__main__':
    ...
    for idx in tqdm(range(20)):
        ...
        target_trajectory = torch.from_numpy(data['q'][0])
        target_trajectory_v = torch.from_numpy(data['v'][0])
    ...
    generate_video_directory(f"{save_folder}/visualize/", list(range(20)), flag="")
    generate_video_directory(f"cantilever_data_sim2sim/visualize/", list(range(20)), flag="")
