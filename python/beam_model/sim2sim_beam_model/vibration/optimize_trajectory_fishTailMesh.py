...
def optimize_trajectoryfull(cantilever:FishTailMeshEnv3d, num_frames, num_epochs, dt, sample=0, suffix = "fix_registration"):
    ...
    target_trajectory_q = np.load(f"fishTailMesh_data_real/trajectory{sample}.npy", allow_pickle=True)[()]['q']
    target_trajectory_v = np.load(f"fishTailMesh_data_real/trajectory{sample}.npy", allow_pickle=True)[()]['v']
