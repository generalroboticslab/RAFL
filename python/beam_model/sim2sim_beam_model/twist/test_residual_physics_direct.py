...
def test_trajectory(
    ...
    vis_1d_folder = f"training_direct_sim2sim/{save_folder.replace('training/', '').replace('/', '_')}_{model_input}"
...
if __name__ == "__main__":
    ...
    save_folder = f"training/test_refactor_element/training_direct"
    sim_errors = []
    res_errors = []
