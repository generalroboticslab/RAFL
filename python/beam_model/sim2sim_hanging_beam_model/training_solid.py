...
from hanging_beam_residual_physics import HangingCantileverResidualPhysics
...
if __name__ == "__main__":
    ...
    if ap.parse_args().config is not None:
        ...
        cantilever_residual = HangingCantileverResidualPhysics(config, save_folder, params)
