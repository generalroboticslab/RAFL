...
def optimize_trajectoryfull( hex_params, num_frames, num_epochs, dt, sample=0, suffix = "liquid", target_dx=0.01):
...
if __name__ == '__main__':
    ...
    for idx in idxs:
        ...
        optimize_trajectoryfull(hex_params, num_frames, num_epochs, 1e-2, sample=idx, suffix="liquid", target_dx=0.01)
