#ifndef PD_ENERGY_META_COROTATED_PD_ELEMENT_ENERGY_H
#define PD_ENERGY_META_COROTATED_PD_ELEMENT_ENERGY_H

#include "pd_energy/pd_element_energy.h"

template<int dim>
class MetaCorotatedPdElementEnergy : public PdElementEnergy<dim> {
public:
