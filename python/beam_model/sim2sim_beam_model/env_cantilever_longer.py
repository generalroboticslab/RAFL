...
class LongerCantileverEnv3d (EnvBase):
    ...
    def __init__(self, seed, folder, options):
        ...
        dx = 0.01 / refinement
        cell_nums = (round(0.12 / dx), round(0.03 / dx), round(0.03 / dx))
        assert cell_nums[0] * dx == 0.12 and cell_nums[1] * dx == 0.03, "Refinement does not properly divide the cantilever dimensions!" 
