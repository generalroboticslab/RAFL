...
def test_trajectory(
    ...
    vis_1d_folder = f"fishTail_finetune_sim2sim/{save_folder.replace('training/', '')}_{model_input}"
...
if __name__ == "__main__":
    ...
    save_folder = "training/test_refactor_element_zero_transformer_direct/fishTail_finetune"
    ...
    cantilever = FishTailEnv3d(42, f"{save_folder}", hex_params)
