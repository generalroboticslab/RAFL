#ifndef PD_ENERGY_META_VOLUME_PD_ELEMENT_ENERGY_H
#define PD_ENERGY_META_VOLUME_PD_ELEMENT_ENERGY_H

#include "pd_energy/pd_element_energy.h"

template<int dim>
class MetaVolumePdElementEnergy : public PdElementEnergy<dim> {
public:
