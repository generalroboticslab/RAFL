...
if __name__ == "__main__":
    ...
    cantilever = ThinnerCantileverEnv3d(42, f"{save_folder}/thinner_scaled/", hex_params)
    ...
    # generate_video_directory(f"{save_folder}/thinner_scaled/visualizations/residual", list(range(12,20)), flag="")
    # generate_video_directory(f"{save_folder}/thinner_scaled/visualizations/base", list(range(12,20)), flag="")
